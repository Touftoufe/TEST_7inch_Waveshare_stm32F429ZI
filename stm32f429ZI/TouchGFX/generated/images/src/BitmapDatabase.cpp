...
extern const unsigned char image_blue_progressindicators_bg_large_circle_indicator_bg_line_full[]; // BITMAP_BLUE_PROGRESSINDICATORS_BG_LARGE_CIRCLE_INDICATOR_BG_LINE_FULL_ID = 2, Size: 184x184 pixels
